...
val moduleName by extra("NeoZygisk PostBoot")
val verName by extra("v2.3-postboot.1")
...
val workDirectory by extra("/debug_ramdisk/neozygisk")
val updateJson by extra("https://raw.githubusercontent.com/igorcv88/NeoZygisk-PostBoot/master/module/zygisk.json")
